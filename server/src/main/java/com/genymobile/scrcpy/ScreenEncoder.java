...
public class ScreenEncoder implements Device.RotationListener {
    ...
    private void internalStreamScreen(Device device, OutputStream outputStream) throws IOException {
        MediaFormat format = createFormat(bitRate, maxFps, codecOptions);
        device.setRotationListener(this);
        boolean alive;
        try {
            do {
                MediaCodec codec = createCodec(encoderName);//根据硬解编码器的名称创建codec
                ...
                try {
                    ...
                    surface = codec.createInputSurface(); // 从codec中获取用于输入的surface
